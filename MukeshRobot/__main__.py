...
buttons = [
    [
        ...
        InlineKeyboardButton(text="𓆩🖤𓆪", url=f"tg://user?id={OWNER_ID}"),
...
HELP_STRINGS = f"""
» *{BOT_NAME}  ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ ᴀʙᴏᴜᴛ sᴘᴇᴄɪғɪᴄs ᴄᴏᴍᴍᴀɴᴅ ɴᴅ ᴏᴛʜᴇʀ ᴇxᴛʀᴀ ʜᴇʟᴘ.* [ᴛʜᴇ ᴋɪɴɢ](tg://user?id=1777270311)"""
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="💛", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="˹ᴅᴇᴠᴇʟᴏᴩᴇʀ˼", url=f"tg://user?id=1777270311"
                        ),
                        InlineKeyboardButton(
                            text="˹sᴏᴜʀᴄᴇ˼",
        ...
        InlineKeyboardButton(text="💛", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="˹ᴏᴡɴᴇʀ˼", url=f"tg://user?id=1777270311"
                        ),
                        InlineKeyboardButton(
                            text="˹ɢɪᴛʜᴜʙ˼", url="https://github.com/NOBITA-RDX"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="◁", callback_data="mukesh_"),
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/NOBITA-RDX/RDX-ROBOT)
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="˹sᴏᴜʀᴄᴇ˼", url="https://t.me/+m4oVCt2zFhYyMTdl")
                ],
                 [
        InlineKeyboardButton(text="💜", callback_data="mukesh_back"),
        InlineKeyboardButton(text="💙", callback_data="mukesh_"),
